...
const envSchema = z.object({
  ...
  COOKIE_DOMAIN: optionalTrimmedString(1),
  ...
  JWT_REFRESH_GRACE_PERIOD_SECONDS: z.coerce.number().int().min(0).max(300).default(30),
...
const env = {
  ...
  jwt: {
    ...
    refreshGracePeriodSeconds: rawEnv.JWT_REFRESH_GRACE_PERIOD_SECONDS,
    refreshGracePeriodMs: rawEnv.JWT_REFRESH_GRACE_PERIOD_SECONDS * 1000,
